...
const byte UnixCore6502[ProgramDIM] = {0xa9, 0xff, 0x8d, 0x03, 0x60, 0xa9, 0x55, 0x8d, 0x01, 0x60, 0xa9, 0xaa, 0x8d, 0x01, 0x60, 0x4c, 0x05, 0x80};
...
unsigned int DATADRB = 0xff; // Data Direction Register B
unsigned int DATADRA = 0xff; // Data Direction Register A
...
void setup() {
  ...
  GPIOH->MODER = (0x00000100 | (GPIOH->MODER & ~0x00000300));
  GPIOB->MODER = (0x00400000 | (GPIOB->MODER & ~0x00C00000));
  GPIOD->MODER = (0x00001000 | (GPIOD->MODER & ~0x00003000));      
  GPIOD->MODER = (0x00000400 | (GPIOD->MODER & ~0x00000C00));      
  GPIOI->MODER = (0x00040000 | (GPIOI->MODER & ~0x000C0000));      
  GPIOH->MODER = (0x04000000 | (GPIOH->MODER & ~0x0C000000));      
  GPIOC->MODER = (0x00004000 | (GPIOC->MODER & ~0x0000C000));
  GPIOG->MODER = (0x10000000 | (GPIOG->MODER & ~0x30000000));
